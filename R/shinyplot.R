## Initializing all Objects that are in the Shiny app later on -----------------------------------------------------------------

Classifier <- selectInput("Classifier", "Select classifier", choices=c("LDA", "QDA", "PDA"))                                        ##Dropdown menu where the classifier functions can be selected
